...
<jsp:setProperty name="DCDY_CXXX" property="*"/>
</jsp:useBean>
...
<%
	...
	if(DCDY_CXXX.doCount()){
	    System.out.println("Modify");
		bl=DCDY_CXXX.doModify();
	}else{
	...
	//更新企业基本信息的状态、申请时间等
	String jbxxSql="UPDATE DCDY_JBXX_SQ SET APPDATE=sysdate,OPETYPE=50,STATUS='0',LOGINID='"+webuser.getLOGINID()+"' WHERE OPENO="+DCDY_CXXX.doPreProcess3(OPENO);
