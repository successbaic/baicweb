...
<br/>
&nbsp;&nbsp;
请录入完整的统一社会信用代码/注册号，以及法定代表人的证件号码，然后点击“下一步”按钮，进行动产抵押设立登记申请。如果所填信息与登记信息不符，系统将不予受理！
<br></td></tr></table>
<FORM NAME="form1" METHOD="POST" ACTION="action/htgl_qyinfo_action.jsp" target="editframe">
