...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td width="20%" align="center" height=50>名称预先核准文号<br/>注册号/统一社会<br/>信用代码</td>
				<td colspan=3  width="30%"><%=WH%></td>
				
				<td width="20%" align="center" height=50>国别<br/>（地区）</td>
				<td  width="30%"><%=icms.getSysDm("COUNTRY",QYDJ_JBXX.getCOUNTRY()) %></td>
			</tr>
			<tr>
...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td align="center" height=50 rowspan="2" width="20%">法定代表人</td>
				<td align="center" width="15%">姓名</td>
				<td colspan="3" align="center"  width="25%"><%=QYDJ_JBXX.getLEREP()%></td>
				
				<td align="center"  width="15%">国别<br/>（地区）</td>
				<td align="center" colspan="2" width="25%"><%=icms.getSysDm("COUNTRY",QYDJ_RYXX.getCOUNTRY()) %></td>
			</tr>
			...
			<tr>
				<td align="center" nowrap="nowrap">企业类型</td>
				<td align="center" colspan="7"><%=icms.getSysDm("ENTTYPE",QYDJ_JBXX.getENTTYPE())%></td>
			</tr>
			<tr>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td width="20%"></td>
				<td align="center" height=28>注册号/<br/>统一社会<br/>信用代码</td>
				<td width="20%"></td>
			</tr>
			<tr>
