...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td width="20%" align="center" height=46 nowrap="nowrap">名称预先核准<br>文号或注册号</td>
	...
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				...
				<td colspan=2 align="center" ><%=SysSystem.toUnderlineStr("","center",7)%>个</td>
			</tr>

			<tr>
			    <td align="center" height=280 >经营范围</td>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td colspan=3><%=czxxBa.getCERNO() %></td>
			</tr>
			<%} else { %>
			<tr>
				<td align="center" rowspan="4" nowrap="nowrap">主管部门<br>（出资人）</td>
