...
java.util.List list = DCDY_ZXXX.getList(" OPENO='"+OPENO+"' and MORCONTNO='"+MORREGCNO+"'");
if(null!=list&&list.size()>0){
	DCDY_ZXXX =(com.macrosoft.icms.htgl.DCDY_ZXXX_SQ )list.get(0);
}
%>
<% String key=DCDY_ZXXX.getMORCANREA();
String value="";
if("1".equals(key)){
	value="当事人提前解除抵押合同";
	...
	value="提交虚假证明文件或其他手段骗取抵押物登记";	
}
%>

<html><head><title>动产抵押注销登记书</title>
</head>
...
<caption align="center"><b>
	<span style="font-size: 16pt"><center>动产抵押注销登记书</center></b><br><br></caption>
<tr>
...
<tr><td align='center' colspan='4'>注销原因</td></tr>
<tr>
<td align='center' colspan='4' height='80'>
<%=value %>;&nbsp&nbsp&nbsp&nbsp备注：
<%=DCDY_ZXXX.getREMARK() %>
</td>
</tr>
</table>
