	...
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				...
				<td colspan=2 align="center"><%=QYDJ_JBXX.doPreProcess(QYDJ_JBXX.getTEL())%></td>
			</tr>
			<tr>
				<td align='center' height=28 width="20%">资金数额</td>
				<td colspan="2" align="center" ><%=SysSystem.toUnderlineStr(QYDJ_JBXX.getREGCAP()+"","center",9)%>万元</td>
