...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td width="20%" align="center" height=28 nowrap="nowrap">名称预先核准文号/注册号/统一<br/>社会信用代码</td>
				<td colspan=5 ><%if(QYDJ_JBXX.getUNISCID().equals("")){out.println(QYDJ_JBXX.getREGNO());}else{out.println(QYDJ_JBXX.getUNISCID());}%></td>
			</tr>
			<tr>
				<td width="20%" align="center" height=50 >住    所</td>
				<td colspan="5" >
...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td align="center" height=28 width="20%">法定代表人<br>姓名</td>
			...
			<tr>
				...
				<td align="center" colspan="2" width="25%"><%=SysSystem.toUnderlineStr("","center",9)%>万元</td>
				<td align="center" nowrap="nowrap">公司类型</td>
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" nowrap="nowrap" height=28 >设立方式</td>
...
<tr>    
	...
	<%
	int bgsxNo=0;
	 for (int i=10;i<bgsxList.size();i++){
		 List temp = (List)bgsxList.get(i);
		//	if(temp.get(2)!=null&&temp.get(2)!=""){
			%>
			<tr>
