...
<html>
	...
	<body bgcolor="#eefbf7" style="margin-top:0;margin-bottom:0">
		...
		<%StepShow stepShow = new StepShow();
			out.println(stepShow.getStep("4", Page.getDL()+Page.getOPETYPE(),Page.getOPENO()));
		%>
		<br/>
		<form name="form1" method="post" action="wsdj_dotj_action.jsp" target="editframe">
		...
		<IFRAME height="0" width="100%" name="editframe" src="" id="editframe" scrolling="no" border="0" align="middle"  frameborder="0"></IFRAME>		
