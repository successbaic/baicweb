...
else if (DL.equals("3")){DL="HZSDJ";}else if (DL.equals("4")){DL="GQDJ";}
...
String sql="SELECT * FROM WSDJ_TBXX WHERE OPETYPE='"+OPETYPE+"' AND DL='"+DL+"' AND XL='"+DL+"' AND XBH='0' ORDER BY BH ";
DbConnection db=new DbConnection();
ResultSet rs=db.executeQuery(sql);
System.out.println(Page.getDL()+"|"+Page.getOPETYPE()+"|"+Page.getOPENO());
%>
...
<br/> 
 <CENTER>
  <div class="subImgs" onclick="window.location.href='gqdj_control.jsp'">下一步</div>
</CENTER> 
