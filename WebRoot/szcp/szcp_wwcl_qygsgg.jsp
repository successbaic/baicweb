...
function body_load(){	
	document.getElementById("LI2").className="secondMenuSel";
}
</script>
</head> 
...
<TABLE width="100%" height="72px" border="1">
  ...
  <table width="100%" border="1" align="center" height="93%" bgcolor="#D5E2EA">
  <tr>
    ...
    <td align="center">
		<iframe id="frmmain" name="main" width="98%" height="98%" scrolling="auto" frameborder="0" src="LI2.jsp"></iframe>
	</td>
  </tr>
  <tr>
