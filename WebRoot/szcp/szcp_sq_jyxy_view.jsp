...
%>
	...
	<%=createHeaderUtil.createHeader_view(regNo,year,CERNO,"5","") %>
	<!-- form表单 -->
		...
		<table border="1" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="REVE_GROW_RATE"
					id="REVE_GROW_RATE" size="40" title="营业收入增长率(%)" maxlength=4
					value="<%=jyxy.getREVE_GROW_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
				<td class="lc2"><input type="text" name="REVE_GROW_RATE1"
					id="REVE_GROW_RATE1" size="40" title="营业收入增长率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="PRI_GROW_RATE"
					size="40" id="PRI_GROW_RATE" title="主营业务利润率(%)" maxlength=4
					value="<%=jyxy.getPRI_GROW_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
				<td class="lc2"><input type="text" name="PRI_GROW_RATE1"
					size="40" id="PRI_GROW_RATE1" title="主营业务利润率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="NET_ASSET_RATE"
					id="NET_ASSET_RATE" size="40" title="净资产收益率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="DEBT_ASSET_RATE"
					id="DEBT_ASSET_RATE" size="40" title="资产负债率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="QUICK_ACT_RATE"
					id="QUICK_ACT_RATE" size="40" title="速动比率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="RECV_TNOV_RATE"
					id="RECV_TNOV_RATE" size="40" title="应收账款周转率(%)" maxlength=4
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="RCV_OVERDUE_RATE"
					...
					maxlength=4 value="<%=jyxy.getRCV_OVERDUE_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
				<td class="lc2"><input type="text" name="RCV_OVERDUE_RATE1"
					id="RCV_OVERDUE_RATE" size="40" title="逾期账款占应收账款比例(%)"
					maxlength=4 value="<%=jyxy1.getRCV_OVERDUE_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
			</tr>
			...
			<tr>
				...
				<td class="lc2"><input type="text" name="PAY_OVERDUE_RATE"
					...
					maxlength=4 value="<%=jyxy.getPAY_OVERDUE_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
				<td class="lc2"><input type="text" name="PAY_OVERDUE_RATE1"
					id="PAY_OVERDUE_RATE" size="40" title="逾期账款占应付账款比例(%)"
					maxlength=4 value="<%=jyxy1.getPAY_OVERDUE_RATE() %>"></input>&nbsp;<font
					color=red>*</font></td>
			</tr>
	...
	function view() {
		...
		var year = '<%=year%>';
		var cerNo = '<%=CERNO%>';
		window.location.href = "szcp_sq_zrxy_view.jsp?REG_NO="+regNo+"&EVAL_YEAR="+year+"&CerNO="+cerNo;
	}	
		function checkError() {
