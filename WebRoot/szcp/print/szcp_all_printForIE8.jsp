...
<div style="text-align: right;" class="noprint">
	...
	<table border="1" width="90%" align="center" bordercolor="#000000">
		...
		<tr>
			...
			<%-- <td align='center' colspan="6"><%=xwgf.getDELEG_TYPEVIEW()%></td> --%>
			<td colspan="6">
			<input type="radio"  disabled ="disabled"name="DELEGTYPE" id="DELEGTYPE" value="1"/>均经书面授权委托
			<input type="radio"  disabled ="disabled"name="DELEGTYPE" id="DELEGTYPE" value="2"/>部分使用书面授权委托
			<input type="radio"  disabled ="disabled"name="DELEGTYPE" id="DELEGTYPE" value="3"/>部分口头授权委托、部分口头授权委托<br/>
			<input type="radio"  disabled ="disabled"name="DELEGTYPE" id="DELEGTYPE" value="4"/>无书面授权委托、全部口头授权委托
			<input type="radio"  disabled ="disabled"name="DELEGTYPE" id="DELEGTYPE" value="5"/>有未授权委托情况</td>
		</tr>
	</table>
	<p class="PageNext"></p><br>
