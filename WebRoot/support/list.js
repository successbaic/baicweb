...
{	
	...
	document.getElementById("editframe").contentWindow.location.href=generateURL( sPage, sPara, urlString );
...
function framejumpToMC2( sPage, sPara, sMessage, sConfirmMessage )
{
	...
	else
	{
		if (window.confirm( sConfirmMessage ))	//确认通过
		{
			document.getElementById("editframe").contentWindow.location.href=generateURL2( sPage, sPara, urlString );
		}
		else
			return;
	}
