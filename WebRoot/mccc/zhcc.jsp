						...
						<tr bgcolor="#FFFFFF">
							...
							<div>
								...
								<input type="text" name="validateCode" id="validateCode"
									style="height: 26px; line-height: 26px; font-size: 18px; width: 80px;height: 26px; background-color: #FFFFFF" />
							&nbsp; &nbsp; 
							<input type="button"
					...
					<div style="text-align: left;  width: 100%;">
						...
						<div id="div_explain" style="display: none; clear: both;">
							<font size="2pt">
								...
								<br />&nbsp;&nbsp;&nbsp;&nbsp;5、若您所申请的名称中的字号存在申请使用记录，将只显示前面的20条。</font>
								<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;若有疑问请登录系统进行查询，或到工商业务大厅进行查询。 </font>
						</div>
