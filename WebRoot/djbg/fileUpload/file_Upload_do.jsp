...
<table border="1" width="100%" height="100%" cellpadding="0" cellspacing="0" align="center" id="table2" rules="rows">	
	<tr>
	...
	<tr>
		<td class='lc1'>文件类型：</td>
		<td class='lc2'>
		<input type="text" id="REMARKS" name="REMARKS" style="width:300px"/>
		<font color="#FF0000">*</font>
		</td>
...
<IFRAME height="350px" width="100%" name="editframe" src="" id="editframe" scrolling="no" border="0" align="middle"  frameborder="0"></IFRAME>
</form>
</body></html>