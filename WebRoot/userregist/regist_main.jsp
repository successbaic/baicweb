...
<table border="0" width="500"  align="center">
		<tr>
			<td width="100%">说明：<br>
	        &nbsp;&nbsp;&nbsp;&nbsp;1.如果您尚未注册，在办理业务前，请先进行用户注册（办理所有业务仅需注册一次）;<br>
	        &nbsp;&nbsp;&nbsp;&nbsp;2.用户名建议使用手机号进行注册;<br>
	        &nbsp;&nbsp;&nbsp;&nbsp;3.注册时，表格中输入框后带红色星号(*)的是必填项，请按照提示正确填写相关信息;<br>
	        &nbsp;&nbsp;&nbsp;&nbsp;4.注册成功后，请牢记用户名和用户密码，需要填写这两项才能登陆系统;<br>
	        </td>
		</tr>
</table>
...
<tr>
	<td class="lc1"  width="150px">用户名：</td>
	<td class="lc2">		
	 <input type="text" id="loginid" name="LOGINID"  size="25" style="width:200px" disblank title='用户名' maxlength=15 onblur="findloginid()">&nbsp;<font color=red>*</font>
...
<tr>
<td class="lc1"  maxlength="20">行政区划：</td>
<td class="lc2" >
...
function findloginid(){
   ...
   if(checkTextEng(form1.LOGINID)){
   		document.getElementById("hiddenframe").contentWindow.location.href="../support/checklogid.jsp?LOGINID="+form1.LOGINID.value;
   }else{
