...
<%	
    ...
    int lastI=0;
	String DOM1="",DOM2="",REGCAP1="",REGCAP2="",REGCAPCUR1="",
			REGCAPCUR2="",CONGRO1="",CONGRO2="",CONGROCUR1="",
			CONGROCUR2="",BUSSCOPE1="",BUSSCOPE2="",
			ENTTYPE1="",ENTTYPE2="",SAVEPERTO1="",SAVEPERTO2="";
	for(int i=0;i<bglist.size();i++){
		...
		if(altitem.equals("04")){
			...
			//bef1="行业门类:"+icms.getSysDm("INDUSTRYPHY", aft);
			...
			//bef2="<br/>行业代码:"+icms.getSysDm("INDUSTRYCO", aft);
	...
	<CENTER>
		<span class="title" >
			...
			<table width="100%" align="center" bordercolor="#000000" border="1">				
				...
				<tr>
				<td align="center" height=30>企业住所</td>
				<td colspan="3"><%=DOM1 %></td>
				<td colspan="3"><%=DOM2 %></td>
				</tr>
				
				<tr>
				<td align="center" height=30>投资总额</td>
				<td><%=CONGRO1 %></td><td>币种</td><td><%=CONGROCUR1 %></td>
				<td><%=CONGRO2 %></td><td>币种</td><td><%=CONGROCUR2 %></td>
				</tr>
				
				<tr>
				<td align="center" height=30>注册资本</td>
				<td><%=REGCAP1 %></td><td>币种</td><td><%=REGCAPCUR1 %></td>
				<td><%=REGCAP2 %></td><td>币种</td><td><%=REGCAPCUR2 %></td>
				</tr>
				
				<tr>
				<td align="center" height=30>投资人<br/>出资额及比例</td>
				<td colspan="3"></td>
				<td colspan="3"></td>
				</tr>
				...
				<tr>
				<td align="center" height=30>企业类型</td>
				<td colspan="3"><%=ENTTYPE1 %></td>
				<td colspan="3"><%=ENTTYPE2  %></td>
				</tr>
