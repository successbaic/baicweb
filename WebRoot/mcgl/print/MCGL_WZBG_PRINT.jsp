...
<%	
	...
	//MCGL_JBXX_ZS.doSelectBySql("SELECT * FROM MCGL_JBXX_ZS WHERE NAMEID='"+MCGL_JBXX.getNAMEID()+"'");
...
%>
<html><head><title>外商投资企业名称变更申请书</title>
</head>
...
<caption align="center"><b>
	<span style="font-size: 16pt">外商投资企业（企业集团）名称<br/>变更核准申请书 
</b><br><br></caption>
<tr>
<td width="140px" rowspan="2" align="center">原企业<br/>（企业集团）名称
</td>
<td width="120px" align="center" height=30>企业名称</td>
<td colspan="5"><%=QYDJ_JBXX_ZS.getENTNAME() %></td>
</tr>
<tr>
<td align="center" height=30  width="120px">集团名称</td>
<td colspan="3"></td>
<td align="center" width="120px">集团简称</td>
<td></td>
</tr>
<tr>
<td align="center" height=30 width="120px">企业住所</td>
<td colspan="6"><%=QYDJ_JBXX_ZS.getDOM() %></td>
</tr>
<tr>
<td align="center" height=30 width="120px">注册资本</td>
<td colspan="2"><%=QYDJ_JBXX_ZS.getREGCAP() %>万元</td>
<td align="center" width="120px">币种</td>
<td><%=icms.getSysDm("CURRENCY", QYDJ_JBXX_ZS.getREGCAPCUR()) %></td>
...
<td colspan="6"><%=QYDJ_JBXX_ZS.getBUSSCOPE() %></td>
</tr>

<tr>
<td rowspan="2" align="center" width="120px">拟变更名称</td>
<td height=30 align="center" width="120px">企业名称</td>
<td colspan="5"><%=MCGL_JBXX.getENTNAME() %></td>
</tr>
<tr>
<td height=30 align="center" width="120px">集团名称</td>
<td colspan="3"></td>
<td align="center" width="120px">集团简称</td>
<td></td>
</tr>
...
<td height=30 align="center" width="120px">企业名称</td>
<td colspan="5"><%=MCGL_JBXX.getENTNAME1() %></td>
</tr>
<tr>
<td height=30 align="center" width="120px">集团名称</td>
<td colspan="3"></td>
...
<tr>
<td height=30 style="border-top-style:none;border-top-width:0px" align="center">投资人姓名或名称</td>
<td style="border-top-style:none;border-top-width:0px" align="center">国别<br/>（地区）</td>
<td style="border-top-style:none;border-top-width:0px" align="center">出资额<br/>（万元）</td>
<td style="border-top-style:none;border-top-width:0px" align="center">币种</td>
<td style="border-top-style:none;border-top-width:0px" align="center">出资<br/>比例</td>
...
<td align="center"><%=icms.getSysDm("COUNTRY", tzrxx.getCOUNTRY()) %></td>
<td align="center"><%=tzrxx.getSUBCONAM() %></td>
<td align="center"><%=icms.getSysDm("CURRENCY", tzrxx.getCURRENCY()) %></td>
<td align="center"><%=tzrxx.getCONPROP() %></td>
...
<table border="1" width="100%" align="center" bordercolor="#000000" >
<tr>
<td height=30  align="center">投资人姓名或名称</td>
...
for(int i=4;i<tzrList.size();i++){
	com.macrosoft.icms.gsnw.MCGL_TZRXX_ZS tzrxx=(com.macrosoft.icms.gsnw.MCGL_TZRXX_ZS)tzrList.get(i);
%>
	<tr>
	<td height=30 align="center"><%=tzrxx.getINV() %></td>
	<td align="center"><%=icms.getSysDm("COUNTRY", tzrxx.getCOUNTRY()) %></td>
