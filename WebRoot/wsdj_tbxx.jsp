...
<tr class="lc1">
<td>需要提交的材料</td>
<td width="60px"><%if(OPETYPE.equals("30")){%>操作<%}else{%>参考模版<%}%></td>
</tr>
<%
String wjsm="";
while(rs.next()){
...
<%}else{
	...
	%>
	<a style="cursor:pointer" href="<%=xgsl%>" target="_blank">参考模版</a>
	<%
	}}
}%>
</td>
...
<br/> 
 ...
 <div id="waitdiv" style="display:none"><img src="images/blue-loading.gif">
  ...
  <div class="subImgs" id="subid" onclick="document.getElementById('subid').disabled=true;document.getElementById('waitdiv').style.display='';window.location.href='qydj_control.jsp'">下一步</div>
</CENTER> 
