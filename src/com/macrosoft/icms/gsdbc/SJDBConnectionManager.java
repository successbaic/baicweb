...
*/
public class SJDBConnectionManager 
{
	static private SJDBConnectionManager instance; // 唯一实例
	...
	*/
	static synchronized public SJDBConnectionManager getInstance() 
	{
		if (instance == null) 
		{
			instance = new SJDBConnectionManager();
		}
		clients++;
		return instance;
	}
	...
	*/
	private void init() 
	{
		InputStream is = getClass().getResourceAsStream("/sjdb.cfg");
