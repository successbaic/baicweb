	...
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				...
				<td align="center" width="20%">姓名或名称</td>
				<td align="center" ><%=QYDJ_JBXX.getLEREP()%></td>
				<td align="center" width="15%">国 别<br/>（地 区）</td>
				<td align="center" colspan="2"><%=icms.getSysDm("COUNTRY",QYDJ_JBXX.getCOUNTRY()) %></td>
			</tr>
			<tr>
				<td align="center" height=30 width="20%">认缴出资额<br/>（万元）</td>
				<td width="10%"><%=QYDJ_JBXX.getREGCAP() %></td>
				<td align="center" width="20%">实缴出资额<br/>（万元）</td>
				<td width="10%"><%=QYDJ_JBXX.getRECCAP() %></td>
				<td align="center" width="15%">币种</td>
				<td width="25%"><%=icms.getSysDm("CURRENCY",QYDJ_JBXX.getREGCAPCUR()) %></td>
			</tr>
			<tr>
