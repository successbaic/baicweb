...
<caption ><b>
	<span style="font-size: 20pt">分公司登记申请书</span></b><br><br>
...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td align='center' height=28 >公司名称</td>
				<td colspan="2" nowrap="nowrap"><%=QYDJ_JBXX.getSUPENTNAME()%></td>
				
				<td align='center' height=28 >公司注册号/统一<br/>社会信用代码</td>
				<td colspan="2"><%=QYDJ_JBXX.getSUPREGNO()%></td>
			</tr>
			<tr>
				<td align='center' height=28 width="20%">分公司名称</td>
				<td colspan="5"><%=QYDJ_JBXX.getENTNAME()%></td>
			</tr>
			<tr>
				<td width="20%" align="center" height=28 nowrap="nowrap" style="font-size:13px;">分公司名称预先核<br/>准文号/注册号/统<br/>一社会信用代码</td>
...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
			    <td align="center" height=28 nowrap="nowrap">分公司<br/>经营范围</td>
				<td colspan="5" align="left" valign="top" style="font-size:13px;">&nbsp;
				</td>
			</tr>
			
			<tr>
			    <td align="center" height=28 nowrap="nowrap">核算方式</td>
	...
	<tr>
		<td>
			...
			<tr>
				<td align="center" height=25 width="20%" >变更/备案项目</td>
	...
	<tr>
		<td>
			...
			<tr>
				<td align="center" height=32>注销原因</td>
				<td colspan="5" >
					&nbsp;&nbsp;
					<%if("32".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 1、分公司被公司撤销;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<%if("31".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 2、分公司被依法责令关闭;<br>
					&nbsp;&nbsp;
					<%if("50".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 3、分公司被吊销营业执照;
					&nbsp;&nbsp;
					<%if("90".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 4、其它原因;<br>
				</td>
			</tr>
			<tr>
				<td align="center" height=32>清税情况</td>
				<td colspan="5" >
					&nbsp;&nbsp;
