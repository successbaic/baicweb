...
<jsp:setProperty name="GQDJ_ZXXX" property="*"/>
</jsp:useBean>
...
<%
	...
	if(GQDJ_ZXXX.doCount()){
	    System.out.println("Modify");
		bl=GQDJ_ZXXX.doModify();
	}else{
	...
	//更新企业基本信息的状态、申请时间等
	String jbxxSql="UPDATE GQDJ_JBXX_SQ SET APPRDATE=sysdate,OPETYPE=50,STATUS='0',LOGINID='"+webuser.getLOGINID()
