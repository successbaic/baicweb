...
*/
public class SzDBConnectionManager 
{
	static private SzDBConnectionManager instance; // 唯一实例
	...
	*/
	static synchronized public SzDBConnectionManager getInstance() 
	{
		if (instance == null) 
		{
			instance = new SzDBConnectionManager();
		}
		clients++;
		return instance;
	}
	...
	*/
	private void init() 
	{
		InputStream is = getClass().getResourceAsStream("/sanZhengDb.cfg");
		...
		{
			System.err.println( "不能读取属性文件. " + "请确保db.cfg在CLASSPATH指定的路径中");
			return;
		}
