...
<IFRAME height="300" width="100%" name="editframe" src="" id="editframe" scrolling="no" border="0" align='center'  frameborder="0">
...
&nbsp;
<a href='#' onclick="framejumpTo('file_Upload_do.jsp','action=1&LEREPSIGN=2');">
...
%>
  <tr>
			...
			<td>
			<a href='../commin_upload/<%=f.getFILEID() %>' target="_blank">查看</a> &nbsp;&nbsp;
			<a href='#' onclick="framejumpToC('file_Upload_delete.jsp','REMARK=delete&OPENO=<%=f.getOPENO()%>&FILEID=<%=f.getFILEID()%>','确定删除该记录吗?');">删除</a>						
			</td>
  </tr>
<%
		}
