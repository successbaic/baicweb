...
<input type="text" style="width:240px" name="ENTNAME" value='<%=DIGITAL_SQ.getENTNAME() %>'><font color='red'>*</font></td>
</tr>
<tr>
<td class="lc1">工商注册号:</td><td class="lc2">
<input type="text" style="width:240px" name="ENTREGNO"   value='<%=DIGITAL_SQ.getENTREGNO() %>'><font color='red'>*</font>
</td>
</tr>
<tr>
<td class="lc1">负责人：</td><td class="lc2">
<input type="text" style="width:240px" name="ENTFZR"  value='<%=DIGITAL_SQ.getENTFZR() %>'><font color='red'>*</font></td>
</tr>
<tr>
<td class="lc1">通信地址：</td>
<td class="lc2"><input type="text" style="width:240px" name="ENTADD"  value='<%=DIGITAL_SQ.getENTADD() %>'><font color='red'>*</font></td>
</tr>
<tr>
<td class="lc1">单位电话：</td><td class="lc2">
<input type="text" style="width:240px" name="ENTTEL"  value='<%=DIGITAL_SQ.getENTTEL() %>'><font color='red'>*</font></td>
</tr>
</table>
<br>
<table border="1" width="100%" align="center">
...
<input type="text" style="width:240px" name="PNAME"  value='<%=DIGITAL_SQ.getPNAME() %>'>
<font color='red'>*</font></td>
<td class="lc1">身份证号：</td><td class="lc2">
<input type="text" style="width:240px" name="PCODE"  value='<%=DIGITAL_SQ.getPCODE() %>'>
<font color='red'>*</font></td>
</tr>
<tr>
<td class="lc1">联系电话:</td><td class="lc2">
<input type="text" style="width:240px" name="PTEL"  value='<%=DIGITAL_SQ.getPTEL() %>'>
<font color='red'>*</font></td>
<td class="lc1">电子邮件:</td><td class="lc2">
<input type="text" style="width:240px" name="EMAIL"   value='<%=DIGITAL_SQ.getEMAIL() %>'></td>
</tr>
</table>
<br>
<table border="1" width="100%" align="center">
...
<br>
<input type='hidden' name='PICPATH' id='PICPATH' value='<%=DIGITAL_SQ.getPICPATH() %>'/>
...
<table border='1' width='90%'>
	...
	<tr><td class="lc1">受理员：<input type='text' name='ACCPTER' disabled value="<%=DIGITAL_SQ.getACCPTER() %>"><br>
	             受理日期:<input type="text" name="SLDATE" title="受理日期"   disabled  value="<%=DIGITAL_SQ.getSLDATE() %>"
	             disblank maxlength=10 datetype=DATE  class="Wdate" onclick="WdatePicker({lang:'zh-cn'})"></font>
		  <br>
		  <input type="radio" name='STATUS' value='2' disabled  checked = '<%="2".equals(DIGITAL_SQ.getSTATUS()) %>' />通过
		  <input type="radio" name='STATUS' value='3' disabled checked = '<%="3".equals(DIGITAL_SQ.getSTATUS()) %>' />驳回
  
	</td>
	<td class="lc1">
		<textarea  name='SQYJ' cols='110' rows='6' disabled><%=DIGITAL_SQ.getSQYJ() %> </textarea>
	</td></tr>
</table>
</td>
</tr>
...
<%if("0".equals(DIGITAL_SQ.getSTATUS())||"3".equals(DIGITAL_SQ.getSTATUS())){ %>
<br>

<table border="1" width="100%" align="center">
<tr>
	<td align="center"><INPUT  type="button" value="提  交" class="butontType" onclick='tj()'></td>	
</tr>
</table>
<%} %>
