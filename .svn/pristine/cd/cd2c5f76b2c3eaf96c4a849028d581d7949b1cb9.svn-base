...
<td valign="middle" align="center">
  <div style="position:relative;width:980px;height:600px;background-image:url(images/welcome/wel.gif)">
  ...
  <div style="cursor:hand;position:absolute;z-index:10;left: 745px;top: 130px;width:200px;height:35px;background-image:url(images/welcome/mcdj.jpg);background-repeat:no-repeat;" onClick="doSub('welcSecond.jsp','0','N')"></div>
  
   <div style="cursor:hand;position:absolute;z-index:10;left: 750px;top: 210px;width:200px;height:35px;background-image:url(images/welcome/qydj.jpg);background-repeat:no-repeat;" onClick="doSub('welcSecond.jsp','1','Y')"></div>
   
    <div style="cursor:hand;position:absolute;z-index:10;left: 725px;top: 290px;width:200px;height:35px;background-image:url(images/welcome/gtdj.jpg);background-repeat:no-repeat;" onClick="doSub('welcSecond.jsp','2','N')"></div>
  
   <div style="cursor:hand;position:absolute;z-index:10;left: 665px;top: 370px;width:200px;height:35px;background-image:url(images/welcome/hzsdj.jpg);background-repeat:no-repeat;" onClick="doSub('welcSecond.jsp','3','N')"></div>
   
    <div style="cursor:hand;position:absolute;z-index:10;left: 585px;top: 450px;width:200px;height:35px;background-image:url(images/welcome/bljd.jpg);background-repeat:no-repeat;" onClick="window.location.href='content.jsp'"></div>
  
  <div style="cursor:hand;position:absolute;z-index:10;left: 772px;top: 17px;width:45px;height:62px;" onClick="window.open('usermodify/modify_main.jsp','displayWindow','top=120,left=150,toolbar=yes,width=880,height=480,directories=yes,status=yes,scrollbars=yes,resizable =yes,menubar=yes')"></div>
  
  <div style="cursor:hand;position:absolute;z-index:10;left: 832px;top: 17px;width:45px;height:62px;" onClick="window.open('help/help.jsp','help','top=120,left=150,toolbar=no,width=800,height=600,directories=no,status=no,scrollbars=yes,resize=yes,menubar=no');"></div>
  
  <div style="cursor:hand;position:absolute;z-index:10;left: 893px;top: 17px;width:45px;height:62px;" onClick="window.open('djbg/djbg.jsp')"></div>
  
  <div style="cursor:hand;position:absolute;z-index:10;left: 832px;top: 523px;width:45px;height:62px;" onClick="javascript:alert('当前已是首页!')"></div>
	  
  <div style="cursor:hand;position:absolute;z-index:10;left: 893px;top: 523px;width:45px;height:62px;" onClick="doLogout()"></div>
...
<%--<map name="Map">
      <area shape="rect" coords="765,14,826,80" href="#" onClick="window.open('usermodify/modify_main.jsp','displayWindow','top=120,left=150,toolbar=yes,width=880,height=480,directories=yes,status=yes,scrollbars=yes,resizable =yes,menubar=yes')" onFocus="this.blur()">
      <area shape="rect" coords="829,14,889,80" href="#" onClick="window.open('help/help.jsp','help','top=120,left=150,toolbar=no,width=800,height=600,directories=no,status=no,scrollbars=yes,resize=yes,menubar=no');" onFocus="this.blur()">
