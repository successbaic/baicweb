...
<tr>
	...
	<td width="15%" height="40" align="center">名 称</td>
	<td height="40" align="center" ><%=QYDJ_JBXX.getSUPENTNAME()%> </td>
	<td width="15%" height="40" align="center">企业注册号/<br/>统一社会信用代码</td>
	<td width="15%" height="40"  align="center" colspan="2"><%=QYDJ_JBXX.getSUPREGNO()%> </td>
</tr>
<tr>
	...
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				...
				<td colspan=2 align="center" width="30%">&nbsp;_______个</td>
			</tr>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td colspan="5" >
					&nbsp;&nbsp;
					<%if("32".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 1、分支机构被上级企业撤销;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<%if("31".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 2、分支机构被依法责令关闭;<br>
					&nbsp;&nbsp;
					<%if("50".equalsIgnoreCase(QYDJ_ZXXX.getCANREA())){out.print(selected);}else{out.print(checkBox);}%> 3、分支机构被吊销营业执照;
					&nbsp;&nbsp;
