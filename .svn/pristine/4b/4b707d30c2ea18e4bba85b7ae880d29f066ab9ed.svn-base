...
*/
public class GsDBConnectionManager 
{
	static private GsDBConnectionManager instance; // 唯一实例
	...
	*/
	static synchronized public GsDBConnectionManager getInstance() 
	{
		if (instance == null) 
		{
			instance = new GsDBConnectionManager();
		}
		clients++;
		return instance;
	}
	...
	*/
	private void init() 
	{
		InputStream is = getClass().getResourceAsStream("/gsdb.cfg");
