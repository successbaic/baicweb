...
或
<span style="cursor:hand" onclick="parent.window.location.href='<%= "http://"+request.getHeader("Host")+request.getContextPath()%>/login.jsp'"><font color=blue>重新登陆 </font></span>		
</td>
</tr>
</table>
