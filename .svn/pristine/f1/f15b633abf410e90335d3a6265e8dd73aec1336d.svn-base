 ...
 (function(){
  ...
  var isConfirmDivBuilded = false;
    function BuildConfirmDiv(){
        ...
        strConfirm +="      </tr>";
        strConfirm +="      <tr>";
        strConfirm +="        <td colspan='2' class='message_button'><input  id='confirmOKButton'  class='button_short' type='button' name='btnOk' value='ÊÇ'/><input  id='confirmCancelButton'  class='button_short' type='button' name='btnOk' value='·ñ'/></td>";
        strConfirm +="      </tr>";
        strConfirm +="    </table>";
        strConfirm +="  </div>";
