...
%>
<form name="form1" method="POST" action="action/dcdy_zxxx_action.jsp" target="editframe">
...
<table width="100%" border=1  >
  <caption align="center">
	<p align="left">动产抵押注销信息</p>
  </caption> 	
<tr>
    <td class="lc1" >注销原因</td>
   <!-- <td class="lc2" width="38%">
        <select size="1" name="MORCANREA" style="width:200" title='注销原因' disblank>
...
<tr>
    <td class="lc1" width="11%">注销日期</td>
    <td class="lc2" width="38%" >
       <input type="text" name="CANDATE" size="15" title="注销日期" datatype=date disblank onclick="dropdowndate(this)">
    </td>
</tr>
<tr>
    <td class="lc1" >备注</td>
