	...
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				...
				<td colspan="5" align="center" ><%=QYDJ_JBXX.getLEREP()%></td>
			</tr>
			<tr>
				<td width="20%" align="center" height=28 >成员出资总额<br/>（元）</td>
				<td colspan="5" >
				<%=QYDJ_JBXX.getREGCAP()%> 元
				</td>
			</tr>
			<tr>
				<td colspan="6" >
				&nbsp;&nbsp;成员总数：
				<%=SysSystem.toUnderlineStr(QYDJ_JBXX.getMEMNUM()+"","center",9) %>
				（名）<br/>
				&nbsp;&nbsp;&nbsp;&nbsp;其中：农民成员
				<%=SysSystem.toUnderlineStr(QYDJ_JBXX.getPEAMEMNUM()+"","center",9) %>
				（名）
				  所占比例 
				  <%=SysSystem.toUnderlineStr(QYDJ_JBXX.getPEAMEMRATE()+"","center",9) %>%<br/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;
				&nbsp;&nbsp;
				 企业、事业单位或社会团体成员：
				 <%=SysSystem.toUnderlineStr(QYDJ_JBXX.getGROMEMNUM()+"","center",9) %>
				 （名）
				  所占比例 <%=SysSystem.toUnderlineStr(QYDJ_JBXX.getGROMEMRATE()+"","center",9) %>%<br/>
				</td>
			</tr>
			<tr>
