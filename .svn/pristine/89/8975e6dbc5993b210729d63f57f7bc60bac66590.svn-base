...
<%
 ...
 %>
<form name="form1" method="POST" action='gqdj_wzllr_action.jsp' target="editframe">
...
<tr> 
	...
	<td class="lc2" ><input type="text" name="MOBTEL" title="移动电话" maxlength=30 datatype="TEL" disblank>&nbsp;<font color="red">*</font></td>  
</tr>
<tr>  
