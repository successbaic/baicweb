...
%>
<form id="form1" name="form1" method="post" ENCTYPE="multipart/form-data" onsubmit="return clicksubmit();" action="web/wsdj_fjxx_action.jsp" target="editframe">
...
<table border="1" width="100%" cellpadding="0" cellspacing="0" align="center" id="table2" rules="rows">	
	...
	<tr>
		...
		if(webuser.getXZQH().equals("3713")){
		 ...
		 %>
		<br>&nbsp;&nbsp;&nbsp;&nbsp;3.上传文件的大小不得超过<%=sizeLength %>M。</font></p>
		</td>
	</tr>	
</table>
