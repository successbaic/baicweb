...
<tr>
	<td>
		<table frame=void border="1" width="100%" align="center" bordercolor="#000000">
			...
			<tr>
				<td align="center" height=28 >出资额</td>
				<td align="center" colspan="2"><%=QYDJ_JBXX.getREGCAP()%> 万元</td>
				<td align="center" nowrap="nowrap">从业人数</td>
				<td align="center" colspan="2"><%=QYDJ_JBXX.getEMPNUM()%></td>
			</tr>
			<tr>
				<td align="center" nowrap="nowrap" height=70 >出资方式</td>
				<td align="left" colspan=5>
					&nbsp;
					<%if("1".equals(QYDJ_JBXX.getSCONFORM())){out.print(selected);}else{out.print(checkBox);}%>1.以个人财产出资<br/>
					&nbsp;
					<%if("2".equals(QYDJ_JBXX.getSCONFORM())){out.print(selected);}else{out.print(checkBox);}%>2.以家庭共有财产作为个人出资。<br/>
					&nbsp;
					出资人的家庭成员签名： 
				</td>
			</tr>
