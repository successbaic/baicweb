...
SysUrlForm.setQueryString("ggxkz_njcx_list.jsp",request);
...
%>
<form name="form1" method="get" action="ggxkz_njcx_list.jsp">
...
if(jbxx.getANCHETYPE().equals("") || jbxx.getANCHETYPE().equals("0")){
%>
<a onclick="javascript:alert('当前广告资格检查信息尚未提交，无法查看！');">
<%
}else{
%>
<a onclick="list_click('nw_ggxkz_control.jsp','SIGN=1&ADBULICNO=<%=jbxx.getADBULICNO()%>&INSYEAR=<%=jbxx.getINSYEAR()%>','');">
<%
}
%>
<img border=0 src='images/icon_find.gif' alt='查看'>
查看
</a></td>
</tr>
<%}%>
