...
String VILLAGE="";
String HOUSENUMBER="";
PROVINCE=jbxx.getPROVINCE();
CITY=jbxx.getCITY();
COUNTY=jbxx.getCOUNTY();
TOWN=jbxx.getTOWN();
VILLAGE=jbxx.getVILLAGE();
HOUSENUMBER=jbxx.getHOUSENUMBER();
...
<select name="COUNTY" id="COUNTY" onchange="writeDOM()"  style="width:150px;" title="县" maxlength=20>
	<%=ContrInfo.getBenShiQuXianOption(icms,XZQH,jbxx.getCITY())%>
</select>
</td>
</tr>
<tr>
<td class="lc1">（乡/民族乡/镇/街道）</td>
<td class="lc2"><input type="text" name="TOWN" id="TOWN" title="乡" size="23" maxlength=25 onchange="writeDOM()"></td>
</tr>
<tr>
<td class="lc1">（路/村/社区）</td>
<td class="lc2"><input type="text" name="VILLAGE" id="VILLAGE" title="村" size="23" maxlength=25 onchange="writeDOM()"></td>
</tr>
<tr>
<td class="lc1">（号）</td>
<td class="lc2"><input type="text" name="HOUSENUMBER" id="HOUSENUMBER" title="号" size="10" maxlength=25 onchange="writeDOM()"></td>
</tr>
<tr>
