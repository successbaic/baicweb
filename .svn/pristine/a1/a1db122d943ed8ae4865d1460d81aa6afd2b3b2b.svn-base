...
<%=createHeaderUtil.createHeader(REG_NO,YEAR,CERNO,"3","") %>
      		...
      		<tr >
	      		...
	      		<tr>
	      			...
	      			<td class="lc2"  colspan="6">
						...
						<input type="radio" name="QUAL_LEVEL_TYPE" id="QUAL_LEVEL_TYPE" value="4"/>无
					</td>
	      		</tr>
	      	</table>
      			</td>
      		...
      		<tr>
      			<td colspan="4">
      				<table border="1" class="table5" width="100%" cellpadding="0" cellspacing="0">
      					<tr>
		      					<td class="lc1" style="width:19%">行业有无合同示范为本</td>
				      			<td class="lc2"  colspan="2">
				      				<c:choose>
      				...
      				<table class="table6" border="1" width="100%" cellpadding="0" cellspacing="0">
      						...
      						<tr>
					      			...
					      			<td class="lc2" colspan="3">
					      					<input type="text" name="INC_SIGN_RATE" id="INC_SIGN_RATE"  size="40" title="收入性合同书面签约率" maxlength=8  value="<%=sl1.getINC_SIGN_RATE() %>" ></input>&nbsp;
					      			</td>
					      			<td class="lc2" colspan="3">
					      					<input type="text" name="INC_SIGN_RATE_TIME" id="INC_SIGN_RATE_TIME"  size="40" title="收入性合同书面签约率" maxlength=8  value="<%=sl2.getINC_SIGN_RATE() %>" ></input>&nbsp;
					      			</td>
					      		</tr>
					      		  ...
					      		  <tr>
					      			...
					      			<td class="lc2"  colspan="3">
					      					<input type="text" name="EXP_SIGN_RATE"  id="EXP_SIGN_RATE" size="40" title="支出性合同书面签约率" maxlength=8  value="<%=sl1.getEXP_SIGN_RATE() %>" ></input>&nbsp;
					      			</td>
					      			<td class="lc2"  colspan="3">
					      					<input type="text" name="EXP_SIGN_RATE_TIME"  id="EXP_SIGN_RATE_TIME" size="40" title="支出性合同书面签约率" maxlength=8 value="<%=sl2.getEXP_SIGN_RATE() %>" ></input>&nbsp;
					      			</td>
					      		</tr>
					      		 ...
					      		 <tr>
					      			...
					      			<td class="lc2"  colspan="3">
					      					<input type="text" name="MODEL_TEXT_US_RATE" id="MODEL_TEXT_US_RATE" size="40" title="合同示范文本使用率" maxlength=8  value="<%=sl1.getMODEL_TEXT_US_RATE() %>" ></input>&nbsp;
					      			</td>
					      			<td class="lc2"  >
					      					<input type="text" name="MODEL_TEXT_US_RATE_TIME" id="MODEL_TEXT_US_RATE_TIME" size="40" title="合同示范文本使用率" maxlength=8 value="<%=sl2.getMODEL_TEXT_US_RATE() %>" ></input>&nbsp;
					      			</td>
					      		</tr>
      				...
      				<table class="table9" border="1" width="100%" cellpadding="0" cellspacing="0">
				      		...
				      		<tr>
				      			<td class="lc2">
				      				...
				      				<input type="checkbox"  name = "GCTCheckBox3"  value="1"  <%="1".equals(xwgf.getGC_RESERCH_FLAG()) ?"checked='checked'":""%>> 有本企业实地调查报告</input>
				      			</td>
				      		</tr>
      			...
      			<td colspan="4">
      					<table class="table10" border="1" width="100%" cellpadding="0" cellspacing="0">
    							<tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="LAST_DFT_OUR_QTY"  id="LAST_DFT_OUR_QTY" size="40" title="本方违约件数" maxlength=6  value="<%=sl1.getLAST_DFT_OUR_QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="LAST_DFT_OUR_QTY_TIME"  id="LAST_DFT_OUR_QTY_TIME" size="40" title="本方违约件数" maxlength=6  value="<%=sl2.getLAST_DFT_OUR_QTY() %>" ></input>&nbsp;
				      			</td>
				      		...
				      		<tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="LAST_DFT_THEY_QTY" id="LAST_DFT_THEY_QTY" size="40" title="对方违约件数" maxlength=6  value="<%=sl1.getLAST_DFT_THEY__QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="LAST_DFT_THEY_QTY_TIME" id="LAST_DFT_THEY_QTY_TIME" size="40" title="对方违约件数" maxlength=6 value="<%=sl2.getLAST_DFT_THEY__QTY() %>" ></input>&nbsp;
				      			</td>
				      		</tr>
				      		 ...
				      		 <tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_COMP_QTY" id="DISP_COMP_QTY" size="40" title="和解件数" maxlength=6  value="<%=sl1.getDISP_COMP_QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_COMP_QTY_TIME" id="DISP_COMP_QTY_TIME" size="40" title="和解件数" maxlength=6  value="<%=sl2.getDISP_COMP_QTY() %>" ></input>&nbsp;
				      			</td>
				      		</tr>
				      		  ...
				      		  <tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_MED_QTY" id="DISP_MED_QTY" size="40" title="调解件数" maxlength=6  value="<%=sl1.getDISP_MED_QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_MED_QTY_TIME" id="DISP_MED_QTY_TIME" size="40" title="调解件数" maxlength=6  value="<%=sl2.getDISP_MED_QTY() %>" ></input>&nbsp;
				      			</td>
				      		</tr>
				      		...
				      		<tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_ARB_QTY"  id="DISP_ARB_QTY" size="40" title="仲裁件数" maxlength=6  value="<%=sl1.getDISP_ARB_QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_ARB_QTY_TIME"  id="DISP_ARB_QTY_TIME" size="40" title="仲裁件数" maxlength=6  value="<%=sl2.getDISP_ARB_QTY() %>" ></input>&nbsp;
				      			</td>
				      		</tr>
				      		 ...
				      		 <tr>
				      			...
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_LAW_QTY" id="DISP_LAW_QTY" size="40" title="诉讼件数" maxlength=6 value="<%=sl1.getDISP_LAW_QTY() %>" ></input>&nbsp;
				      			</td>
				      			<td class="lc2" colspan="2">
				      				<input type="text" name="DISP_LAW_QTY_TIME" id="DISP_LAW_QTY_TIME" size="40" title="诉讼件数" maxlength=6  value="<%=sl2.getDISP_LAW_QTY() %>" ></input>&nbsp;
				      			</td>
				      		</tr>
      					</table>
      			</td>
...
<script type="text/javascript">
	function checkError() {
		...
		if(FULLTIME_MNG_QTY == null || FULLTIME_MNG_QTY == "") {
			...
			var flag = fucCheckInt(FULLTIME_MNG_QTY);
			if(flag==0){
		...
		if(PARTTIME_MNG_QTY == null || PARTTIME_MNG_QTY == "") {
			...
			var flag = fucCheckInt(PARTTIME_MNG_QTY);
			if(flag==0){
		...
		if(INC_SIGN_RATE == null || INC_SIGN_RATE == "") {
			...
			if(flag==0){
				...
				if(INC_SIGN_RATE.indexOf(".") >= 0) {
					var arr = INC_SIGN_RATE.split(".");
					if(arr[1].length > 2) {
						alert("收入性合同书面签约率,最多为2位小数");
						return
					}
				}else {
					if(INC_SIGN_RATE.length > 3) {
						alert("收入性合同书面签约率,最多输入3位整数");
						return
					}
				}
			}
		...
		var INC_SIGN_RATE_TIME = $("#INC_SIGN_RATE_TIME").val();
		if(INC_SIGN_RATE_TIME == null || INC_SIGN_RATE_TIME == "") {
			alert("请输入收入性合同书面签约率");
			return;
		}else{
			var flag = fucCheckNUM(INC_SIGN_RATE_TIME);
			if(flag==0){
				alert("收入性合同书面签约率,请输入正确的数字格式");
				return;
			}else {
				if(INC_SIGN_RATE_TIME.indexOf(".") >= 0) {
					var arr = INC_SIGN_RATE_TIME.split(".");
					if(arr[1].length > 2) {
						alert("收入性合同书面签约率,最多为2位小数");
						return
					}
				}else {
					if(INC_SIGN_RATE_TIME.length > 3) {
						alert("收入性合同书面签约率,最多输入3位整数");
						return
					}
				}
		...
		if(EXP_SIGN_RATE == null || EXP_SIGN_RATE == "") {
			...
			if(flag==0){
				...
				if(EXP_SIGN_RATE.indexOf(".") >= 0) {
					var arr =EXP_SIGN_RATE.split(".");
					if(arr[1].length > 2) {
						alert("支出性合同书面签约率,最多为2位小数");
						return
					}
				}else {
					if(EXP_SIGN_RATE.length > 3) {
						alert("支出性合同书面签约率,最多输入3位整数");
						return
					}
				}
			}
		...
		var EXP_SIGN_RATE_TIME = $("#EXP_SIGN_RATE_TIME").val();
		if(EXP_SIGN_RATE_TIME == null || EXP_SIGN_RATE_TIME == "") {
			alert("请输入支出性合同书面签约率");
			return;
		}else{
			var flag = fucCheckNUM(EXP_SIGN_RATE_TIME);
			if(flag==0){
				alert("支出性合同书面签约率,请输入正确的数字格式");
				return;
			}else {
				if(EXP_SIGN_RATE_TIME.indexOf(".") >= 0) {
					var arr =EXP_SIGN_RATE_TIME.split(".");
					if(arr[1].length > 2) {
						alert("支出性合同书面签约率,最多为2位小数");
						return
					}
				}else {
					if(EXP_SIGN_RATE_TIME.length > 3) {
						alert("支出性合同书面签约率,最多输入3位整数");
						return
					}
				}
		...
		if(MODEL_TEXT_US_RATE == null || MODEL_TEXT_US_RATE == "") {
			...
			if(flag==0){
				...
				if(MODEL_TEXT_US_RATE.indexOf(".") >= 0) {
					var arr =MODEL_TEXT_US_RATE.split(".");
					if(arr[1].length > 2) {
						alert("合同示范文本使用率,最多为2位小数");
						return
					}
				}else {
					if(MODEL_TEXT_US_RATE.length > 3) {
						alert("合同示范文本使用率,最多输入3位整数");
						return
					}
				}
			}
		...
		var MODEL_TEXT_US_RATE_TIME = $("#MODEL_TEXT_US_RATE_TIME").val();
		if(MODEL_TEXT_US_RATE_TIME == null || MODEL_TEXT_US_RATE_TIME == "") {
			alert("请输入合同示范文本使用率");
			return;
		}else{
			var flag = fucCheckNUM(MODEL_TEXT_US_RATE_TIME);
			if(flag==0){
				alert("合同示范文本使用率,请输入正确的数字格式");
				return;
			}else {
				if(MODEL_TEXT_US_RATE_TIME.indexOf(".") >= 0) {
					var arr =MODEL_TEXT_US_RATE_TIME.split(".");
					if(arr[1].length > 2) {
						alert("合同示范文本使用率,最多为2位小数");
						return
					}
				}else {
					if(MODEL_TEXT_US_RATE_TIME.length > 3) {
						alert("合同示范文本使用率,最多输入3位整数");
						return
					}
				}
		...
		var LAST_DFT_OUR_QTY_TIME = $("#LAST_DFT_OUR_QTY_TIME").val();
		if(LAST_DFT_OUR_QTY_TIME == null || LAST_DFT_OUR_QTY_TIME == "") {
			alert("请输入本方违约件数");
			return;
		}else{
			var flag = fucCheckInt(LAST_DFT_OUR_QTY_TIME);
			if(flag==0){
				alert("本方违约件数,请输入正确的数字格式");
				return;
			}
		...
		var LAST_DFT_THEY_QTY_TIME = $("#LAST_DFT_THEY_QTY_TIME").val();
		if(LAST_DFT_THEY_QTY_TIME == null || LAST_DFT_THEY_QTY_TIME == "") {
			alert("请输入对方违约件数");
			return;
		}else{
			var flag = fucCheckInt(LAST_DFT_THEY_QTY_TIME);
			if(flag==0){
				alert("对方违约件数,请输入正确的数字格式");
				return;
			}
		...
		var DISP_COMP_QTY_TIME = $("#DISP_COMP_QTY_TIME").val();
		if(DISP_COMP_QTY_TIME == null || DISP_COMP_QTY_TIME == "") {
			alert("请输入和解件数");
			return;
		}else{
			var flag = fucCheckInt(DISP_COMP_QTY_TIME);
			if(flag==0){
				alert("和解件数,请输入正确的数字格式");
				return;
			}
		...
		var DISP_MED_QTY_TIME = $("#DISP_MED_QTY_TIME").val();
		if(DISP_MED_QTY_TIME == null || DISP_MED_QTY_TIME == "") {
			alert("请输入调解件数");
			return;
		}else{
			var flag = fucCheckInt(DISP_MED_QTY_TIME);
			if(flag==0){
				alert("调解件数,请输入正确的数字格式");
				return;
			}
		...
		var DISP_ARB_QTY_TIME = $("#DISP_ARB_QTY_TIME").val();
		if(DISP_ARB_QTY_TIME == null || DISP_ARB_QTY_TIME == "") {
			alert("请输入仲裁件数");
			return;
		}else{
			var flag = fucCheckInt(DISP_ARB_QTY_TIME);
			if(flag==0){
				alert("仲裁件数,请输入正确的数字格式");
				return;
			}
		...
		var DISP_LAW_QTY_TIME = $("#DISP_LAW_QTY_TIME").val();
		if(DISP_LAW_QTY_TIME == null || DISP_LAW_QTY_TIME == "") {
			alert("请输入诉讼件数");
			return;
		}else{
			var flag = fucCheckInt(DISP_LAW_QTY_TIME);
			if(flag==0){
				alert("诉讼件数, 请输入正确的数字格式");
				return;
			}
