...
%>
<html><head><title>合作社名称变更申请书</title>
</head>
...
<caption align="center"><b>
	<span style="font-size: 16pt">合作社名称<br/>变更核准申请书 
</b><br><br></caption>
<tr>
<td width="140px" align="center">原合作社<br/>名称
</td>
<td width="120px" align="center" height=30>合作社名称</td>
<td colspan="3"><%=QYDJ_JBXX_ZS.getENTNAME() %></td>
</tr>

<tr>
<td align="center" height=30 width="120px">住所</td>
<td colspan="4"><%=QYDJ_JBXX_ZS.getDOM() %></td>
</tr>
<tr>
<td height=180 align="center" width="120px">经营范围</td>
<td colspan="4"><%=QYDJ_JBXX_ZS.getBUSSCOPE() %></td>
</tr>

<tr>
<td align="center" width="120px">拟变更名称</td>
<td height=30 align="center" width="120px">合作社名称</td>
<td colspan="3"><%=MCGL_JBXX.getENTNAME() %></td>
</tr>


<tr>
<td align="center" width="120px">备选名称</td>
<td height=30 align="center" width="120px">合作社名称</td>
<td colspan="3"><%=MCGL_JBXX.getENTNAME1() %></td>
</tr>
...
<td height=30 style="border-top-style:none;border-top-width:0px" align="center">成员类型</td>
...
<td height=30 align="center"><%=icms.getSysDm("MEMTYPE", tzrxx.getINVTYPE()) %></td>
