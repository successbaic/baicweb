...
<%
	...
	DCDY_JBXX.doSelectBySql(" SELECT * FROM DCDY_JBXX_SQ WHERE MORREGCNO='"+MORREGCNO+"' AND REGORUN='"+REGORUN+"' AND MORTGAGO='"+MORTGAGO+"' AND MORTGAGORTYPE='0' AND STATUS='2'");
	...
	out.print("<script language='javascript'>parent.window.location.href='../dcdy_xgcl.jsp'</script>");	
%>
</body>
</html>