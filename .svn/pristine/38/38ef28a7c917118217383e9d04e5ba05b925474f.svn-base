...
%>
<html><head><title>非公司外资企业注销登记申请书</title>
...
<caption align="center"><b>
	<span style="font-size: 16pt">非公司外资企业注销登记申请书</b><br><br></caption>
<tr>
...
<tr>
	<td align="center" height="40" nowrap="nowrap">企业类型</td>
...
<tr>
	...
	<td align="center" height=40  colspan="1" nowrap="nowrap" nowrap="nowrap">分支机构注销<br/>登记情况</td>
	<td colspan="2" nowrap="nowrap">&nbsp;&nbsp;
	<%if("1".equalsIgnoreCase(QYDJ_ZXXX.getCANCELBRSIGN())){out.print(selected);}else{out.print(checkBox);}%> 已办理完毕&nbsp;&nbsp;&nbsp;
	<%if("2".equalsIgnoreCase(QYDJ_ZXXX.getCANCELBRSIGN())){out.print(selected);}else{out.print(checkBox);}%> 无分支机构</td>
...
<tr>
    ...
    <td width="15%" nowrap="nowrap" align="left"><%=QYDJ_ZXXX.getPUBNEWSNAME()%></td>

    <td align="center" height="40">公告日期</td>
    <td nowrap="nowrap" align="left"><%=QYDJ_ZXXX.getPUBDATE()%></td>
</tr>
<tr>
	<td align="center">申请人声明</td>
	<td colspan="5">
	   <br><p style="line-height: 30px">&nbsp;&nbsp;&nbsp;&nbsp;本企业依照相关法律法规有关规定申请注销登记，提交材料真实有效。</p><br><br>
		<p >
