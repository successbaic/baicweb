...
GTDJ_JBXX_SQ.doSelectBySql("SELECT * FROM GTDJ_JBXX_SQ WHERE PRIPID='"+pripid+"'");
GTDJ_JYZXX_SQ.doSelectBySql("SELECT * FROM GTDJ_JYZXX_SQ WHERE PRIPID='"+pripid+"'");
String entname=GTDJ_JBXX_SQ.getTRANAME();
String regno=GTDJ_JBXX_SQ.getREGNO();
String dom=GTDJ_JBXX_SQ.getOPLOC();
String certype=GTDJ_JYZXX_SQ.getCERTYPE();
String cerno=GTDJ_JYZXX_SQ.getCERNO();
String name=GTDJ_JYZXX_SQ.getNAME();
String enttype="9999";

//System.out.println("SIGN="+SIGN+",OPENO="+OPENO+",OPETYPE="+OPETYPE);
%>
<br/>
<form name="form1" action="action/dcdy_jbxx_gt_action.jsp" method="post" target="editframe">
...
<tr>      
	...
	<td class="lc2" colspan="6">
		...
		<input type="radio" value="1" name="MORTGAGOTYPE" checked> 个体工商户&nbsp;
