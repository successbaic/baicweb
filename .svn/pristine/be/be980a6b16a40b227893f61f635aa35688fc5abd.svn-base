...
function calendar(){
	...
	tmpHTML+="<input type=button style='"+buttonStyle+"' id=\"button_today \" value=\"今日" +_calendarControl.todayYear+"-"+(_calendarControl.todayMonth+1)+"-"+_calendarControl.todayDay+"\" onclick=\"calendar_todayClick()\"";
