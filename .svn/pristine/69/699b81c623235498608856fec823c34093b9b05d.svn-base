...
<html>
	...
	<body>
		...
		%>
		<br/>
		<form name="form1" method="post" action="action/dcdy_dotj_action.jsp" target="editframe">
		...
		<IFRAME height="0" width="0" name="editframe" src="" id="editframe" scrolling="no" border="0" align="middle"  frameborder="0" ></IFRAME>		
